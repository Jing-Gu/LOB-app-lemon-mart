...
export class AuthService {
  ...
  constructor(
   ...
   signup(email: string, passward: string){
      return this.http.post<IServerAuthResponse>(`https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${this.api}`,
        {
          email: email,
          password: passward,
   ...
   login(email: string, passward: string){
     return this.http.post<IServerAuthResponse>(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=${this.api}`,
        {
          email: email,
          password: passward,
          returnSecureToken: true
   ...
   private handleAuthentication(
     ...
     expiresIn: number,
      ...
      this.autoLogout(expiresIn * 1000) //expiresIn is in sec, *1000 gives mille sec
